%% Normative modelling of MS data: adults
...
% Children; MS and group data from RAGU
    ...
    load('%%path%%/Adults20_MS_ERPsMaster.mat')

    Data_Master = struct();
    Data_Master.Subj = str2double(Adults20_MS_ERPmaster.Subj);
    Data_Master.Group = rd.IndFeature;
    Data_Master.Age = [];
    Data_Master.MS1 = Adults20_MS_ERPmaster.MS1;
    Data_Master.MS2 = Adults20_MS_ERPmaster.MS2;
    Data_Master.MS3 = Adults20_MS_ERPmaster.MS3;
    Data_Master.MS4 = Adults20_MS_ERPmaster.MS4;
    Data_Master.MS5 = Adults20_MS_ERPmaster.MS5;
    Data_Master.MS6 = Adults20_MS_ERPmaster.MS6;

    
    clear Adults20_MS_ERPmaster rd
...
% figures
saveas(Fig_NM_MS1,'Adult_NormMod_MS1.png');
saveas(Fig_NM_MS2,'Adult_NormMod_MS2.png');
saveas(Fig_NM_MS3,'Adult_NormMod_MS3.png');
saveas(Fig_NM_MS4,'Adult_NormMod_MS4.png');
saveas(Fig_NM_MS5,'Adult_NormMod_MS5.png');
saveas(Fig_NM_MS6,'Adult_NormMod_MS6.png');
...
% save data
save('Adul_NormMod_data.mat','DeviantScores','DevScores_ASD_mean',...
